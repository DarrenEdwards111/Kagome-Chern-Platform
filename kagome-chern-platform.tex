...
Under this assumption, Table~\ref{tab:clrc} shows the resulting scaling. These numbers illustrate the \emph{potential} of a large-gap platform for error correction, but should not be interpreted as predictions for a specific physical system.
